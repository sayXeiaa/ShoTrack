        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <form action="{{ route('players.bulkUpload') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div id="upload-section" class="hidden">
                            ...
                            <div class="mt-8">
                                ...
                                <p>Ensure to format the excel file as "Plain Text" to avoid errors.</p>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const schoolTemplateRoute = "{{ route('players.template.download.school') }}";
        const nonSchoolTemplateRoute = "{{ route('players.template.download.nonSchool') }}";
