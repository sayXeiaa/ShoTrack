                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('schedules.update', $schedule->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <select name="tournament_id" id="tournament_id" class="border-gray-300 shadow-sm rounded-lg" style="width: 50ch;">
                                    ...
                                    @foreach($tournaments as $tournament)
                                        <option value="{{ $tournament->id }}" {{ $tournament->id == $schedule->tournament_id ? 'selected' : '' }}>
                                            {{ $tournament->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="my-3">
                                <input type="datetime-local" id="match_date" name="match_date" value="{{ old('match_date', $schedule->match_date) }}" class="border-gray-300 shadow-sm rounded-lg" style="width: 50ch;">
                                @error('match_date')
                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="my-3">
                                <input type="text" id="venue" name="venue" placeholder="Enter Match Venue" value="{{ old('venue', $schedule->venue) }}" class="border-gray-300 shadow-sm rounded-lg" style="width: 50ch;">
                                @error('venue')
                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="my-3">
                                <select name="team1_id" id="team1_id" class="border-gray-300 shadow-sm rounded-lg" style="width: 50ch;">
                                    ...
                                    @foreach($teams as $team)
                                        <option value="{{ $team->id }}" {{ $team->id == $schedule->team1_id ? 'selected' : '' }}>
                                            {{ $team->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="my-3">
                                <select name="team2_id" id="team2_id" class="border-gray-300 shadow-sm rounded-lg" style="width: 50ch;">
                                    ...
                                    @foreach($teams as $team)
                                        <option value="{{ $team->id }}" {{ $team->id == $schedule->team2_id ? 'selected' : '' }}>
                                            {{ $team->name }}
                                        </option>
                                    @endforeach
                                </select>
