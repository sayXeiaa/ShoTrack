                            ...
                            <div class="bg-gray-100 border border-gray-300 rounded-lg p-2 w-full max-w-sm">
                                <div class="text-center">
                                    <div class="grid grid-cols-6 gap-1">
                                        ...
                                        <!-- Team 1 Initials -->
                                        <div class="team-initials">{{ $schedule->team1->team_acronym ?? getInitials($schedule->team1->name) }}</div>
                                        ...
                                        <!-- Team 2 Initials -->
                                        <div class="team-initials">{{ $schedule->team2->team_acronym ?? getInitials($schedule->team2->name) }}</div>
