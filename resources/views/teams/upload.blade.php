        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <form action="{{ route('teams.bulkUpload') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div id="upload-section" class="hidden">
                            ...
                            <div class="mt-8">
                                <label class="text-lg font-medium">Upload the CSV or Excel file containing team data:</label> 
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const schoolTemplateRoute = "{{ route('teams.template.download.school') }}";
        const nonSchoolTemplateRoute = "{{ route('teams.template.download.nonSchool') }}";
        ...
        const updateVisibility = () => {
            ...
            const tournamentType = selectedOption?.getAttribute('data-tournament-type'); // Safely access the attribute
