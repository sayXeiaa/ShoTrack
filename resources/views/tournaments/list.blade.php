                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-3 text-center">
                                <div class="flex flex-col sm:flex-row sm:justify-center space-y-2 sm:space-y-0 sm:space-x-2">
                                    <a href="{{ route('tournaments.edit', $tournament->id) }}" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2 hover:bg-slate-600">
                                        Edit
                                    </a>
                                    <a href="javascript:void(0);" onclick="deletetournament({{ $tournament->id }})" class="bg-red-600 text-sm rounded-md text-white px-3 py-2 hover:bg-red-500">
                                        Delete
                                    </a>
                                </div>
                            </td>                            
